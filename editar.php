...
<div class="login">
	...
	if(isset($_POST['Login'])){
		...
		$actualiza="UPDATE pacientes1 SET fecha='$fecha' WHERE cedula='$cedula'";
		$resultado = mysqli_query( $conn, $actualiza);

		if($resultado){
			echo 			"Cambio correcto";
		}else{
			echo "Cambio no se pudo realizar";
		}
	...
	?>		
			...
			<center><h2>CAMBIA LA FECHA DE LA RESERVA</h2></center>
			...
			<input type="submit" name="Login" value="ACTUALIZAR" class="primary-button login-button">
